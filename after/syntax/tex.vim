...
" mathscr letters
syn match texMathSymbol '\\mathscr{\s*A\s*}' contained conceal cchar=𝒜
syn match texMathSymbol '\\mathscr{\s*B\s*}' contained conceal cchar=ℬ
syn match texMathSymbol '\\mathscr{\s*C\s*}' contained conceal cchar=𝒞
syn match texMathSymbol '\\mathscr{\s*D\s*}' contained conceal cchar=𝒟
syn match texMathSymbol '\\mathscr{\s*E\s*}' contained conceal cchar=ℰ
syn match texMathSymbol '\\mathscr{\s*F\s*}' contained conceal cchar=ℱ
syn match texMathSymbol '\\mathscr{\s*G\s*}' contained conceal cchar=𝒢
syn match texMathSymbol '\\mathscr{\s*H\s*}' contained conceal cchar=ℋ
syn match texMathSymbol '\\mathscr{\s*I\s*}' contained conceal cchar=ℐ
syn match texMathSymbol '\\mathscr{\s*J\s*}' contained conceal cchar=𝒥
syn match texMathSymbol '\\mathscr{\s*K\s*}' contained conceal cchar=𝒦
syn match texMathSymbol '\\mathscr{\s*L\s*}' contained conceal cchar=ℒ
syn match texMathSymbol '\\mathscr{\s*M\s*}' contained conceal cchar=ℳ
syn match texMathSymbol '\\mathscr{\s*N\s*}' contained conceal cchar=𝒩
syn match texMathSymbol '\\mathscr{\s*O\s*}' contained conceal cchar=𝒪
syn match texMathSymbol '\\mathscr{\s*P\s*}' contained conceal cchar=𝒫
syn match texMathSymbol '\\mathscr{\s*Q\s*}' contained conceal cchar=𝒬
syn match texMathSymbol '\\mathscr{\s*R\s*}' contained conceal cchar=ℛ
syn match texMathSymbol '\\mathscr{\s*S\s*}' contained conceal cchar=𝒮
syn match texMathSymbol '\\mathscr{\s*T\s*}' contained conceal cchar=𝒯
syn match texMathSymbol '\\mathscr{\s*U\s*}' contained conceal cchar=𝒰
syn match texMathSymbol '\\mathscr{\s*V\s*}' contained conceal cchar=𝒱
syn match texMathSymbol '\\mathscr{\s*W\s*}' contained conceal cchar=𝒲
syn match texMathSymbol '\\mathscr{\s*X\s*}' contained conceal cchar=𝒳
syn match texMathSymbol '\\mathscr{\s*Y\s*}' contained conceal cchar=𝒴
syn match texMathSymbol '\\mathscr{\s*Z\s*}' contained conceal cchar=𝒵

" mathcal letters
syn match texMathSymbol '\\mathcal{\s*A\s*}' contained conceal cchar=𝓐
syn match texMathSymbol '\\mathcal{\s*B\s*}' contained conceal cchar=𝓑
syn match texMathSymbol '\\mathcal{\s*C\s*}' contained conceal cchar=𝓒
syn match texMathSymbol '\\mathcal{\s*D\s*}' contained conceal cchar=𝓓
syn match texMathSymbol '\\mathcal{\s*E\s*}' contained conceal cchar=𝓔
syn match texMathSymbol '\\mathcal{\s*F\s*}' contained conceal cchar=𝓕
syn match texMathSymbol '\\mathcal{\s*G\s*}' contained conceal cchar=𝓖
syn match texMathSymbol '\\mathcal{\s*H\s*}' contained conceal cchar=𝓗
syn match texMathSymbol '\\mathcal{\s*I\s*}' contained conceal cchar=𝓘
syn match texMathSymbol '\\mathcal{\s*J\s*}' contained conceal cchar=𝓙
syn match texMathSymbol '\\mathcal{\s*K\s*}' contained conceal cchar=𝓚
syn match texMathSymbol '\\mathcal{\s*L\s*}' contained conceal cchar=𝓛
syn match texMathSymbol '\\mathcal{\s*M\s*}' contained conceal cchar=𝓜
syn match texMathSymbol '\\mathcal{\s*N\s*}' contained conceal cchar=𝓝
syn match texMathSymbol '\\mathcal{\s*O\s*}' contained conceal cchar=𝓞
syn match texMathSymbol '\\mathcal{\s*P\s*}' contained conceal cchar=𝓟
syn match texMathSymbol '\\mathcal{\s*Q\s*}' contained conceal cchar=𝓠
syn match texMathSymbol '\\mathcal{\s*R\s*}' contained conceal cchar=𝓡
syn match texMathSymbol '\\mathcal{\s*S\s*}' contained conceal cchar=𝓢
syn match texMathSymbol '\\mathcal{\s*T\s*}' contained conceal cchar=𝓣
syn match texMathSymbol '\\mathcal{\s*U\s*}' contained conceal cchar=𝓤
syn match texMathSymbol '\\mathcal{\s*V\s*}' contained conceal cchar=𝓥
syn match texMathSymbol '\\mathcal{\s*W\s*}' contained conceal cchar=𝓦
syn match texMathSymbol '\\mathcal{\s*X\s*}' contained conceal cchar=𝓧
syn match texMathSymbol '\\mathcal{\s*Y\s*}' contained conceal cchar=𝓨
syn match texMathSymbol '\\mathcal{\s*Z\s*}' contained conceal cchar=𝓩
